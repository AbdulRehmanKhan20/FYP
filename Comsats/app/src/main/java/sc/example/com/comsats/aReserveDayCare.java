...
public class aReserveDayCare extends URL implements View.OnClickListener {
    ...
    String HttpURL = BASE_URL+"add_ReserveDayCare.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_a_reserve_day_care);
        ...
        switch (view.getId()) {
            ...
            case R.id.btnLogout:
                ...
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    finish();
                    Intent i = new Intent(aReserveDayCare.this, Login.class);
                    i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                    startActivity(i);

                } else {
                    Toast.makeText(aReserveDayCare.this,
    ...
    void pickDate(final EditText et_Pick)
    {
        ...
        // date picker dialog
        picker = new DatePickerDialog(aReserveDayCare.this,
    ...
    private void addDayCare() {
        ...
        {
            Toast.makeText(aReserveDayCare.this, "Please Fill the Fields", Toast.LENGTH_LONG).show();
    ...
    public void UserLoginFunction(final String Reservation, final String startDate , final String endDate){
        ...
        class UserLoginClass extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                try{
                progressDialog = ProgressDialog.show(aReserveDayCare.this,"Loading Data",null,true,true);
                }catch (Exception e)
                {
                    e.getMessage();
                }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                progressDialog.dismiss();
                    ...
                    Toast.makeText(aReserveDayCare.this, message, Toast.LENGTH_LONG).show();
