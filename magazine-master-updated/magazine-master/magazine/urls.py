...
from journals.views import list_published_journals_for_homepage
...
urlpatterns = [
    path('', list_published_journals_for_homepage, name='home'),
    path('home/', list_published_journals_for_homepage, name='mainhome'),
